package com.solodroid.yourradioappsinglestation.services;
...
public class ArtGetter {
    ...
    public static String getImageForQuery(final String query, final AlbumCallback albumCallback, final Context context) {
